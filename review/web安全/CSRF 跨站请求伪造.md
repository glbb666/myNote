...
（Cross Site Request Forgy） 打开同一浏览器时其他的网站对本网站造成的影响。原理就是攻击者构造出一个后端请求地址，诱导用户点击或者通过某些途径自动发起请求。如果用户是在登录状态下的话，后端就以为是用户在操作，从而进行相应的逻辑。 [![原理](https://github.com/zyg1999/Note/raw/master/review/web%E5%AE%89%E5%85%A8/pic/csrf.png)](https://github.com/zyg1999/Note/blob/master/review/web安全/pic/csrf.png)
