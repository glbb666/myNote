...
值得注意的是， Web Worker 规范中定义了两类工作线程，分别是专用线程**Dedicated Worker**和共享线程 **Shared Worker**，其中，Dedicated Worker只能为一个页面所使用，而Shared Worker则可以被被运行在同源的所有进程访问。
